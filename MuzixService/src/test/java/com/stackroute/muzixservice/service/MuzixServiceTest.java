...
public class MuzixServiceTest {
    ...
    public void setUp(){
        ...
        track = new Track("Track1", "Mynewtrack","new comments","123","new trak url", artist);
    ...
    public void testUpdateCommentsSuccess() throws TrackNotFoundException {
        when(muzixRepository.findById(track.getTrackId())).thenReturn(optional);
        track.setComments("Test comments updated");
        ...
        Assert.assertEquals(fetchtrack.getComments(), "Test comments updated");
